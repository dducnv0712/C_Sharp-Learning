...
namespace c_Sharp_Learning.session5
{
       public class Program
    {
        public static void Main(string[] args)
        {
            Thread t1 = new Thread(Run20Times); // truyen vao function se chay khi start thread
        ...
        public static void Run20Times(Object obj) // neu co tham so thi chi dc 1 tham so Object
        {
